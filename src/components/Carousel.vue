...
<template>
  ...
  >
      ...
      >
        <picture>
          ...
          <img
            ...
            class="max-h-screen w-full skeleton object-cover"
            height="1080"
            loading="lazy"
    ...
    <div
      v-if="swiper"
      class="
        pointer-events-none absolute inset-0 z-10 container-fluid flex-col
        justify-between gap-4 px-container py-4
        md:flex-row md:items-end md:py-8 md:text-2xl
      "
    ...
    <div
      v-if="swiper"
      class="
        absolute inset-y-0 left-0 z-10 hidden w-1/4 cursor-arrow-left
        lg:flex
      "
    ...
    <div
      v-if="swiper"
      class="
        absolute inset-y-0 right-0 z-10 hidden w-1/4 cursor-arrow-right
        lg:flex
      "
