...
<template>
  ...
  >
    <div class="container-fluid px-container">
      <div class="border-white relative border-l">
        <button
          class="
        ...
        <Transition name="fade">
          <div
            ...
            class="
              pointer-events-none flex flex-col justify-between
              lg:-mt-22 lg:flex-row
            "
          >
            ...
            <div
              class="
                py-4 text-lg
                md:py-6 md:text-xl
                lg:order-first lg:w-1/2 lg:pt-28 lg:pr-16
              "
            >
              {{ item.content }}
            </div>
